...
$msg = @{
    AutoPathFound    = "Dossier CloudSave de Splitgate trouvé automatiquement :"
    PathNotFound     = "Dossier CloudSave de Splitgate introuvable dans le chemin par défaut."
    UsingCurrentDir  = "Utilisation du répertoire actuel du script comme base :"
    FolderCreated    = "Dossier manquant créé automatiquement :"
    BackupPrompt     = "Voulez-vous sauvegarder vos dossiers MapCreator / MapCreatorPrefab (et le manifeste) d'abord ? (O/N)"
    BackupExists     = "Une sauvegarde pour aujourd'hui existe déjà, écrasement en cours :"
    BackupNative     = "Sauvegarde des cartes natives uniquement..."
    SkipBackupFolder = "Saut de la sauvegarde de {0} (aucun dossier de carte native)"
    BackupManifest   = "CloudSaveManifest.json sauvegardé."
    BackupDone       = "Sauvegarde terminée :"
    BackupSkipped    = "Sauvegarde ignorée."
    ReadingManifest  = "Lecture du manifeste existant..."
    ParseError       = "[ABORTÉ] Impossible d'analyser le fichier CloudSaveManifest.json existant en tant que JSON."
    MissingFields    = "[ABORTED] Le manifeste a été analysé, mais les champs attendus (Version/Files) sont manquants."
    ParsedOk         = "  Analysé avec succès : Version={0}, {1} entrées existantes."
    NoManifest       = "Aucun manifeste existant trouvé. Création automatique d'un nouveau."
    NoOwnerIdNote    = "Remarque : Aucun OwnerId trouvé. Les nouvelles entrées seront créées sans champ OwnerId."
    ActionUpdated    = "MIS À JOUR"
    ActionNew        = "NOUVEAU"
    ActionRemoved    = "SUPPRIMÉ (communauté) : {0} - .bin introuvable, suppression du manifeste"
    DoneSuccess      = "Terminé. Manifeste mis à jour :"
    TotalEntries     = "Total des entrées : {0} ({1} natives, {2} communauté)"
}
