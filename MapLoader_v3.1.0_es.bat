...
$msg = @{
    AutoPathFound    = "Carpeta CloudSave de Splitgate encontrada automáticamente:"
    PathNotFound     = "Carpeta CloudSave de Splitgate no encontrada en la ruta predeterminada."
    UsingCurrentDir  = "Usando el directorio actual del script como base:"
    FolderCreated    = "Carpeta faltante creada automáticamente:"
    BackupPrompt     = "¿Deseas respaldar tus carpetas MapCreator / MapCreatorPrefab (y el manifiesto) primero? (S/N)"
    BackupExists     = "Ya existe un respaldo para hoy, sobrescribiéndolo:"
    BackupNative     = "Respaldateando solo mapas nativos..."
    SkipBackupFolder = "Omitiendo respaldo de {0} (sin carpetas de mapas nativos)"
    BackupManifest   = "CloudSaveManifest.json respaldado."
    BackupDone       = "Respaldo completado:"
    BackupSkipped    = "Respaldo omitido."
    ReadingManifest  = "Leyendo manifiesto existente..."
    ParseError       = "[CANCELADO] No se pudo analizar el CloudSaveManifest.json existente como JSON."
    MissingFields    = "[CANCELADO] El manifiesto fue analizado, pero faltan los campos esperados (Version/Files)."
    ParsedOk         = "  Analizado OK: Versión={0}, {1} entradas existentes."
    NoManifest       = "No se encontró un manifiesto existente. Creando uno nuevo automáticamente."
    NoOwnerIdNote    = "Nota: No se encontró OwnerId en ninguna parte. Las nuevas entradas se crearán sin el campo OwnerId."
    ActionUpdated    = "ACTUALIZADO"
    ActionNew        = "NUEVO"
    ActionRemoved    = "ELIMINADO (comunidad): {0} - .bin ya no se encuentra, eliminándolo del manifiesto"
    DoneSuccess      = "Listo. Manifiesto actualizado:"
    TotalEntries     = "Total de entradas: {0} ({1} nativas, {2} comunidad)"
}
